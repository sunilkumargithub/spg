...
export class GeofenceModalComponent implements OnInit {
  ...
  editshape() {
    ...
    if (originalcoords.startsWith("CIRCLE")) {
      ...
      console.log('clatlong' , clatlong);
// const customcenter = [];
// customcenter[0] = '47.808724022599783';
// customcenter[1] = '-89.1215390721982';
// const customradius = '5000000';
  ...
  drawtestcircle(radius: Number, center) {
    ...
    const customlat = '';
    const customlong = '';
    // "CIRCLE (23.261086362929053 -88.99822330501284, 2462.971409674734)"
    // 22.625865, 88.471193
    // airportcenter = 22.651261, 88.446206
    const  baseLayer = new ol.layer.Tile({
      source: new ol.source.OSM()
  });
const  circle = new ol.geom.Circle(ol.proj.transform([longitude, latitude], 'EPSG:4326', 'EPSG:3857')  , Number(radius));
...
target: 'amap',
view: new ol.View({
center: ol.proj.transform([88.471193,  22.625865], 'EPSG:4326', 'EPSG:3857'),
zoom: 6
}),
units: 'm'
});
...
console.log('drawcircle radius' , radius);
    ...
    var feature = new ol.Feature({
      // geometry: new ol.geom.Polygon([polyco])
      geometry: new ol.geom.Circle(radius ,  center)
  ...
  //   var circle = new ol.geom.Circle(comingcenter, radius);
  ...
  // }
   ...
   drawCircleInMeter = function(map, radius , center) {
console.log('map' , map);
console.log('radius' , radius);
console.log('center' , center);
// var view = map.getView();
// var projection = view.getProjection();
// var resolutionAtEquator = view.getResolution();
// var centerr = map.getView().getCenter();
// var pointResolution = projection.getPointResolution(resolutionAtEquator, center);
// var resolutionFactor = resolutionAtEquator/pointResolution;
// var radius = (radius / ol.proj.METERS_PER_UNIT.m) * resolutionFactor;
  ...
  addInteraction(type) {
    ...
    // const value = 'Polygon';
    {
      ...
      //  const changedcenter  = ol.proj.transform(center[1] , center[0]  ,  'EPSG:4326'  , 'EPSG:3857');
       console.log('ceter at changedcenter ', changedcenter);
